...
| `furnishing_rent_status` | String (Category) | Tình trạng nội thất (Nội thất đầy đủ, Thô...) |
| `is_good_room` | Integer | Đánh giá của nền tảng phòng tốt hay không (0 là không tốt, 1 là tốt) |
| `deposit` | Float | Tiền cọc (VNĐ) |
